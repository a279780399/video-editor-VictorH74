  ...
  return (
    <div className="h-screen grid place-items-center">
      ...
      <h2 className="text-7xl bg-gradient-to-r from-red-200 from-10% via-blue-500 via-50% to-cyan-400 to-100% bg-clip-text text-transparent">Tudo certo! <span className="animate-shake">👍</span></h2>
        <a href={exportedVideoUrl!} download={`${videoName}__vh-editor.mp4`} className="bg-gradient-to-r from-red-200 from-10% via-blue-500 via-50% to-cyan-400 to-100% uppercase font-medium p-4 rounded-lg text-white hover:scale-105 duration-200">Clique aqui para baixar o vídeo</a>
      </main>
    </div>
  );
}
